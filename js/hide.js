$(document).ready(function() {
 ...
 // put all your jQuery goodness in here.
   $(".has_image2").change(function() {
     if(this.checked) {
	
	//alert($(this).attr('name'));
        $('#'+$(this).attr('name')).slideDown(1000);
		
	
     }
     else {
	 
        $("#"+$(this).attr('name')).slideUp(1000); 
   ...
   $(".has_image").change(function() {
     ...
     if(this.checked) {
        ...
        $("#addtional1").slideDown(1000);
		
	
     }
     else {
		 var cnt=0;
		 $(".has_image").each(function(){
			 if(this.checked) 
				 cnt++;
  ...
  $('[name="pay_project"]').change(function() {   
