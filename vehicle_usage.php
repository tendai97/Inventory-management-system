...
$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE type = 'vhcluse' and active = 1 $sqlfilter";
//echo $query;
	...
	$targetpage = "index.php?c=vehicle_usage"; 	//your file name  (the name of this file)
	...
	$sql="SELECT * FROM parameters WHERE  type = 'vhcluse' and active= 1 $sqlfilter ORDER BY name LIMIT $start, $limit ";
	...
	if(isset($_GET['msg'])) echo "<center><strong><font color=green>".$_GET['msg']."</font></strong></center>"; 
					...
					?> 
      <br/><legend>Vehicle Usage Management</legend>
...
<thead>
  	...
  	<tr>
		...
		<td width="35"><a href="index.php?c=veh_use_edit&id=<?php echo $row['id'];?>">[Edit]</a>
		<a onclick="return confirm('CONFIRM you want to Permanently Delete this Vehicle Body Type?')" href="index.php?c=veh_use_edit&id=<?php echo $row['id'];?>&op=D">]Delete]</a></td>
...
<div id="respond"></div>
<p><a href="index.php?c=veh_use_edit" class="btn btn-theme-dark btn-ico btn-lg">Add Vehicle Usage</a></p>
    </div>