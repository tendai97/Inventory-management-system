			...
			<h3 class="heading-progress"><font color = "ff0000"><p class="blinking"><strong> **** YOUR DASHBOARD ALERTS **** </strong></p></font><span class="pull-right"></span></h3>
				...
				<?php if($_SESSION[SITE_NAME]['usertype']=="Admin"){?>
					   ...
					   <div class="progress">
                        ...
                        </div><h3 class="heading-progress"> You have Asset Administration Alerts  – to view or action click  <a href="index.php?c=assert_admin&alert=1">here</a><span class="pull-right"></span></h3>
                          <?php 
						  $alerts=$alerts+1;
						}
	...
	<?php }  } 
			...
			elseif($emp->hierarchy_ind <> "S") {
					...
					<!--	<div class="progress">
                        ...
                        </div><h3 class="heading-progress"> You have Asset Management Alerts  – to view or action click  <a href="index.php?c=admin_asset&app=ATM&alert=1">here</a><span class="pull-right"></span></h3>
						   <?php 
						}
...
<div class="progress">
	...
	?>
            <div class="progress">
					...
					<p><br/></p>
					<legend>Select The Module To Retrieve Quick Reference Guide For</legend>
					<br/>
 						<td width="262"><select name='module' id="module" class="form-control">
							<option value="" >Select Module For Quick Reference Guide</option>
							<option value="CA" >WWF Central Administration</option>
							<option value="ATM" >Asset Tracking & Management</option>
							<option value="LAM" >Leave & Absence Management</option>
							<option value="VLM" >Vehicle Logging and Management</option>
							<option value="RPO" >Requisitions & Purchase Orders</option>
							<option value="TAE" >Travel advances and expenses</option>
						  </select></td>
