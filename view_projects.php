<div id="content">
      <legend>View Project Details      </legend>
...
$query = "SELECT COUNT(*) as num FROM $tbl_name where active= 1 ". $sqlfilter;
	...
	$targetpage = "index.php?c=view_projects"; 	//your file name  (the name of this file)
...
?>
	 ...
	 <input name="return" type="hidden" value="view_customer_details.php">
      ...
      <!--tr>
        ...
        <td bgcolor="#FFFFFF"><div align="center"><strong><span class="style1">View Project Details </span></strong></div></td>
...
<thead>
          <tr>
			...
			<!--th width="80">Budget Code</th>-->
            <th width="80">Budget Holder </th>
        ...
        <!--td width="80"><?php echo $row['budget_code']; ?></td>-->

		<td width="80"><?php echo $row['budget']; ?></td>
