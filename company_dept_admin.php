...
$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE  active =1 ".$sqlfilter;
	...
	$targetpage = "index.php?c=company_dept_admin"; 	//your file name  (the name of this file)
...
$sql="SELECT * FROM company_dept WHERE  active= 1".$sqlfilter." ORDER BY name desc LIMIT $start, $limit ";
...
?>
	 ...
	 <input name="return" type="hidden" value="view_customer_details.php">
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF"><div align="center"><strong><span class="style1">View Department Details </span></strong></div></td>
      ...
      <tr>
		...
		<td width="130"><a href="index.php?c=company_dept_edit&id=<?php echo $row['id'];?>"><img src="images/edit-icon.png" border="0" alt="edit" /></a></td>
		
		<td width="49"><a onclick="return confirm('CONFIRM you want to Deactivate this Department Record?')" href="index.php?c=company_dept_edit&id=<?php echo $row['id'];?>&op=D">Deactivate</a></td>
		</tr> 
...
<div id="respond"></div>
<p><a href="index.php?c=company_dept_edit"><img src="images/add_user.gif" width="280" height="34" alt= "Add Department"/></a></p>
    </div>