...
window.close('','_self');return true;}
 ...
 <p><br/></p>
      <legend>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Change Of Vehicle Registration Number On An Existing WWF Fleet Vehicle</legend>  
	
		<tr><td><center><span style="color: red;"><strong>CAUTION:-</strong> Changing The Registration Number Of An Existing Vehicle Will Result In The Unlinking Of ALL Previously Captured Records For This Vehicle Under The Old Registration Number. If In Doubt Click The <strong>EXIT</strong> Button!!</span></center></td></tr><br/>	  
  <?php
		...
		elseif (isset($_POST['choice']) && ($_POST['choice'] == "N")) { 
				...
				$sql="UPDATE  `vehicle_requests` SET `alert_flag` = 'N', `request_status` = 'User Declined', status_reason = 'User Did Not Accept WWF Vehicle Usage Terms & Conditions' WHERE `id` = '$id'";
						$db->query($sql); 
	...
	<form action="" method="post">
	  ...
	  <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 ">
		  <tr>
			<td><span style="color: blue;">Old Registration No.</span></td>
			<td><input name="old_reg_no" type="text" class="form-control" id="old_reg_no" placeholder="Enter the OLD Vehicle Reg no (for verification)" required></td>
		  </tr>
	   <br/>
	  </div>
	  <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 ">
		  <tr>
			<td><span style="color: blue;">New Registration No.</span></td>
			<td><input name="new_reg_no" type="text" class="form-control" id="new_reg_no" placeholder="Enter the NEW Vehicle Reg no (the replacement)" required></td>
		  </tr>
	   <br/>
	  </div>
	  <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 ">
      <tr>
	   <tr><td><span style="color: blue;">Reason For Changing Vehicle Registration Number</span></td></tr>
	       <td><input name="reason" type="text" class="form-control" id="reason" placeholder="Enter reason for the change here" required></td>
	   </tr>
	   <br/>
	  </div>
	  ...
	  <p>
		...
		<td><button class="btn-small btn-color btn-pad" onclick="javascript:window.open('','_self').close();return true;">Exit</button></td>
      </p>
    </form>