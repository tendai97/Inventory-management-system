...
$query = "SELECT COUNT(*) as num FROM $tbl_name where active= 1 ". $sqlfilter;
	...
	$targetpage = "index.php?c=company_dept"; 	//your file name  (the name of this file)
...
$sql = "SELECT * FROM $tbl_name  where active= 1  $sqlfilter ORDER BY id desc LIMIT $start, $limit ";
...
?>
	 ...
	 <input name="return" type="hidden" value="view_customer_details.php">
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF"><div align="center"><strong><span class="style1">View Company / Department Details </span></strong></div></td>
