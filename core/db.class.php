<?php
  ...
  class DB
  {
    ...
    function DB($base, $server, $user, $pass)
    {
      ...
      $this->connection= mysqli_connect($server, $user, $pass,$base) or die('Server connexion not possible.');
    ...
    function debug($debug, $query, $result = NULL)
    {
      ...
      if ($result == NULL)
        echo "<p style=\"margin: 2px;\">Number of affected rows: ".mysqli_affected_rows($this->connection)."</p></div>";
      else
