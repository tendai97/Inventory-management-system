 <div id="content">
      <legend>View Asset Class & Type Details      </legend>
...
$query = "SELECT COUNT(*) as num FROM $tbl_name where active= 1 ". $sqlfilter;
	...
	$targetpage = "index.php?c=assert_type"; 	//your file name  (the name of this file)
...
$sql = "SELECT * FROM $tbl_name  where active= 1  $sqlfilter ORDER BY class, code LIMIT $start, $limit ";
...
?>
	 ...
	 <input name="return" type="hidden" value="view_customer_details.php">
      ...
      <!--tr>
        ...
        <td bgcolor="#FFFFFF"><div align="center"><strong><span class="style1">View Asset Type Details </span></strong></div></td>
      ...
      <tr>
        ...
        <td align="center"><table width="100%"  border="0" cellspacing="0" cellpadding="0" class="table table-striped table-bordered">
          ...
          <tr>
            ...
            <td width="87"><strong>Class Code</strong></td>
			<td width="96"><strong>Class Description </strong></td>
			<td width="87"><strong>Type Code </strong></td>
			<td width="96"><strong>Type Description </strong></td>           
			<td width="87"><strong>Status </strong></td>

         <!--   <td width="130"><strong>Procurement Date</strong></td>
			<td width="128"><strong>View Dependants</strong></td>
...

		{
 		...
 		$phpdate = date("d/m/Y",$phpdate);
       	...
       	<td width="87"><?php echo $row['class']; ?></td>
		...
		<td width="96"><?php echo $row['name']; ?></td>
		<td width="96"><?php echo $row['status']; ?></td>
