<div id="content">
      <legend>Asset Class Data      </legend>
...
$query = "SELECT COUNT(*) as num FROM $tbl_name where active= 1  $adminregion ". $sqlfilter;
	...
	$targetpage = "index.php?c=asset_group"; 	//your file name  (the name of this file)
...
$sql = "SELECT * FROM $tbl_name  where active= 1  $adminregion $sqlfilter ORDER BY id desc LIMIT $start, $limit ";
...
?>
	 ...
	 <input name="return" type="hidden" value="view_customer_details.php">
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF"><div align="center"><strong><span class="style1">View Asset Class Details </span></strong></div></td>
      ...
      <tr>
        ...
        <td align="center"><table width="100%"  border="0" cellspacing="0" cellpadding="0" class="table table-striped table-bordered">
          ...
          <tr>
            ...
            <td width="87"><strong> Asset Class Code </strong></td>
		...
		<td width="126"><?php echo $row['name']; ?></td>
        <td width="103"><?php echo $row['description']; ?></td>
		<td width="126"><?php echo $row['status']; ?></td>
