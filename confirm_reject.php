<div id="content">
      <legend>Reject Asset Activation</legend>
      <?php 
	...
	VALUES	( '".$_GET['assert_no']."','$line->asset_group','$line->asset_type','Deactivation','Asset Deactivated Permanently','$reason', '".$_SESSION[SITE_NAME]['username']."', NOW())";
		...
		$sql="UPDATE `assets`  SET  alloc_status = 'New Asset Activation Rejected', alert_flag='N', active ='0', d_method = '$reason', custodian = NULL	WHERE `assert_no` = '".$_GET['assert_no']."'";
			$db->query($sql);
		//$sql="	
		...
		//echo $sql;
			...
			echo "<font color=red > You have successfully Rejected Activation of this Asset which has now been Deactivated permanently!!</font><br><br>" ;
     ...
     <form action="" method="post">
       <table width="300"  border="0" cellspacing="0" cellpadding="0">
	    ...
	    <input type="text" id="asset"  placeholder="Asset Number" class="validate[required,length[0,100]] form-control text-input" <?php if (isset($_GET['assert_no'])) echo "value='".$_GET['assert_no']."' readonly"?> required/>
		  ...
		  <br />
		  <textarea rows="2" cols="70" name="reason" placeholder="Enter Reason for Rejecting Activation" id="reason"  required/><?php echo $line->d_method ;?></textarea>
         </tr> 
      ...
      <p>
        <?php if ($line->alloc_status == 'New Asset Activation Rejected') { ?>
